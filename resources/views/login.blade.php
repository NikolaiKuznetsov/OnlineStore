...
@section('content')
    <div class="w-full mt-8 flex justify-center items-center">
        <form action="{{ route('process.signIn') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="{{ route('signOut') }}">Регистрация</a>
            </div>
        </form>
    </div>
@endsection

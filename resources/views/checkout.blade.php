        ...
        <div class="flex flex-col lg:flex-row mt-8">
            ...
            <div class="w-full lg:w-1/2 order-2 lg:mt-0 mt-5">
                <div class="flex lg:justify-end">
                    <form action="{{ route('save.order') }}" method="POST" class="lg:w-3/4">
                        @csrf
                        <div class="mt-2">
                            <h4 class="text-sm text-gray-500 font-medium">Введите пароль от Вашей учётной записи для оформления заказа</h4>
                            <div class="mt-6 flex">
                                <label class="block flex-1">
                                    <input type="password" class="border p-1.5 block w-full rounded-md border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 mt-1" placeholder="Password">
                                </label>
                                <div id="validationPassword" class="hidden"></div>
                            </div>
                        </div>
